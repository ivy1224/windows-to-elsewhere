    ...
    <main className="min-h-screen bg-white">
      ...
      <footer className="bg-white border-t border-gray-200 py-12 px-4 mt-16">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          <div className={`text-gray-700 text-lg mb-2 ${playfair.className}`} style={{ marginBottom: '2.5rem' }}>“Life is made of temporary elsewheres.”</div>
          <div className={`text-gray-500 text-base flex flex-col md:flex-row md:justify-center md:space-x-6 items-center ${playfair.className}`}>
          ...
          <div className={`text-gray-400 text-sm mt-4 ${playfair.className}`}>⟢ Made with ☕ in United Kingdom ｜ © 2025 Windows to elsewhere</div>
        </div>
      </footer>
    </main>
  );
